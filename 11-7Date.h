...
public:
	...
	*/
	...
	DateClass() {
		...
		//現在の日付を要素別に変換
		struct tm* localDate = localtime(&currentDate);

		//年を初期化
		classYear = localDate->tm_year + 1900;
		//月を初期化
		classMonth = localDate->tm_mon + 1;
		//日を初期化
		classDay = localDate->tm_mday;
	}

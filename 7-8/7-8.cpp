...
* @since 7.17
*/
void removeArray(int intArray[], int arraySize, int deleteIndex, int deleteNumber)
{
	//配列の要素を削除するためのループ
	for (int firstCounter = deleteIndex; firstCounter < arraySize; ++firstCounter) {

		//消去される要素以降にある要素は消去数ぶん配列をズラす
...
int main()
{
	...
	//入力した添字の要素を消去することを告知
	cout << "入力した添字の要素を消去し、以降の要素を前にずらします。\n";
	...
	do {
		...
		//入力された添字が0より小さい場合、または最大の添え字より大きい場合再入力
